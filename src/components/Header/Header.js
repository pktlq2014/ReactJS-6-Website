...
import flipkartLogo from "../../assets/images/logo/flipkart.png";
import goldenStar from "../../assets/images/logo/golden-star.png";
        ...
        <div className="grid wide">
          <nav className="nav__navbar hide-on-tablet-mobile">
            ...
            <ul className="header__navbar-list">
              ...
              <li className="header__navbar-signed header__navbar-item-link header__navbar-control header__navbar-item header__navbar-item--saparate">
                  ...
                  <li className="header__cart-item">
                    ...
                    <div className="header__cart-item-container-text">
                      <div className="header__cart-item-header">
                        <p className="header__cart-item-info">
                          Product...
                        </p>

                        <div className="header__cart-item-container-price">
                          <p className="header__cart-item-price">100$</p>
                          <p className="header__cart-item-multiple">x</p>
                          <p className="header__cart-item-quantity">1</p>
                        </div>
                      </div>
                      ...
                      <div className="header__cart-item-body">
                        ...
                        <span className="header__cart-item-remove">Delete</span>
                      </div>
                    </div>
                  </li>
                </ul>
